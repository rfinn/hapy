...
def main(args=None):
    ...
    for i in range(len(gra)):
        ...
        params = dict(
            ...
            rimage_fwhm_se_arcsec=float(image_set.r.fwhm_se_arcsec) if image_set.r.fwhm_se_arcsec is not None else None,
            rimage_fwhm_phot_arcsec=float(image_set.r.fwhm_phot_arcsec) if image_set.r.fwhm_phot_arcsec is not None else None,
            himage_fwhm_se_arcsec=float(image_set.h.fwhm_se_arcsec) if (himage and image_set.h.fwhm_se_arcsec is not None) else None,
            himage_fwhm_phot_arcsec=float(image_set.h.fwhm_phot_arcsec) if (himage and image_set.h.fwhm_phot_arcsec is not None) else None,
