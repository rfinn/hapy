...
def main(args=None):
    ...
    for i in range(len(gra)):
        ...
        params = dict(
            ...
            rimage_fwhm_psf_arcsec=float(image_set.r.fwhm_psf_arcsec) if image_set.r.fwhm_psf_arcsec is not None else None,
            himage_fwhm_se_arcsec=float(image_set.h.fwhm_se_arcsec) if (himage and image_set.h.fwhm_se_arcsec is not None) else None,
            himage_fwhm_psf_arcsec=float(image_set.h.fwhm_psf_arcsec) if (himage and image_set.h.fwhm_psf_arcsec is not None) else None,
